...
class BeerControllerTest {
    ...
    void testCreateNewBeer() throws Exception {
        BeerDTO beer = beerServiceImpl.getBeers(null, null, false).getFirst();
    ...
    void testCreateBeerNullBeerName() throws Exception {
        ...
        given(beerService.saveNewBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.getBeers(null, null, false).getFirst());
    ...
    void testGetBeerById() throws Exception {
        BeerDTO testBeer = beerServiceImpl.getBeers(null, null, false).getFirst();
